...
CONFIG1=configs/configs_fast_phase1_all.yml
...
END1=/scratch/1/project/co_neurips/debug/fast_adv_models/${PREFIX1}epsilon${EPSILON}_alpha${ALPHA}_unif${UNIF}_clip${CLIP}/checkpoint_epoch6.pth.tar
